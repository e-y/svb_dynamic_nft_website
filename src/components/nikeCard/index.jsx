...
export function NikeCard(props) {
  ...
  const rotateY = useTransform(x, [-100, 100], [0, 0]);

  return (
    <CardWrapper>
      <CardContainer
        style={{ x, y, rotateX, rotateY, z: 100,  backgroundImage: "url(/img/raw_front_infos.png)" }}
        drag
        dragElastic={0.16}
        ...
        <TopContainer>
          <ShoesWrapper>
            <Shoes
              ...
              whileTap={{ cursor: "grabbing" }}
            >
              <img src={`${process.env.PUBLIC_URL}/img/donk.png`} />
            </Shoes>
          </ShoesWrapper>
